...
module.exports = {
  ...
  messages: {
    ...
    'app.home.sub-slogan': '极简·高效·低熵值',
    'app.home.vision': '这是一套致力于提升「全生命周期」体验的中后台设计语言。',
    'app.footer.repo': '仓库',
    ...
    'app.publish.title': 'lud@2.0.0 发布！',
